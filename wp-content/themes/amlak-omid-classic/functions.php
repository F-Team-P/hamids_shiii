...
function amlak_omid_assets() {
	// Persian web fonts (Amiri naskh for prestige display headings, Vazirmatn for UI).
	wp_enqueue_style(
		'amlak-omid-fonts',
		'https://fonts.googleapis.com/css2?family=Amiri:wght@400;700&family=Vazirmatn:wght@400;500;700;800;900&display=swap',
		array(),
		null
	);
