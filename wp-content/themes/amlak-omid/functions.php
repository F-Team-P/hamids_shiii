...
function amlak_omid_assets() {
	// Persian web fonts (Vazirmatn for UI, Lalezar for display headings).
	wp_enqueue_style(
		'amlak-omid-fonts',
		'https://fonts.googleapis.com/css2?family=Lalezar&family=Vazirmatn:wght@400;500;700;800;900&display=swap',
		array(),
		null
	);
